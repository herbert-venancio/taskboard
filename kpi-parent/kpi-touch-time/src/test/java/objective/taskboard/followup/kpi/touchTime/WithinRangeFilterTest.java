...
public class WithinRangeFilterTest {
    ...
    private WithinRangeFilterAsserter filter() {
    	return new WithinRangeFilterAsserter();
    }
    ...
    private class WithinRangeFilterAsserter {

		private String projectStartDate;
		private String projectEndDate;
		private FixedClock clock = new FixedClock();

		public WithinRangeFilterAsserter startingAt(String projectStartDate) {
			this.projectStartDate = projectStartDate;
			return this;
		}

		public void issueShouldNotBeAccepted(IssueKpi kpi) {
	        WithinRangeFilter filter = getFilter();
		...
		public WithinRangeFilterAsserter todayIs(String today) {
			clock.setNow(DateTimeUtils.parseDateTime(today).toInstant());
			return this;
		}

		public WithinRangeFilterAsserter endingAt(String projectEndDate) {
		...
		private WithinRangeFilter getFilter() {
	        ...
	        return new WithinRangeFilter(timezone,defaultRange);
		}
