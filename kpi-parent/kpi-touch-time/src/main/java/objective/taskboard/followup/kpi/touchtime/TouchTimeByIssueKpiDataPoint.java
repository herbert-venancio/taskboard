...
class TouchTimeByIssueKpiDataPoint {
    ...
    public TouchTimeByIssueKpiDataPoint(String issueKey, String issueType, String issueStatus, double effortInHours, Instant startProgressingDate, Instant endProgressingDate) {
