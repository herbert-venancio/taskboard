...
public class FullTouchTimeTest {
    ...
    private DSLKpi dsl() {
        ...
        dsl.environment()
                .types()
                    .addDemand("Demand")
                    .bulkPutFeatures("Feature", "Bug", "Task")
                    .bulkPutSubtasks("UAT", "Frontend Development", "Backend Development")
                    .bulkPutSubtasks("Subtask", "Tech Planning", "Feature Planning")
                    .bulkPutSubtasks("UX", "Alpha Test", "Alpha Bug")
                    .bulkPutSubtasks("Functional Test", "Functional Review", "QA")
                .eoT()
                .givenKpiProperties()
                    ...
                    .atFeatureHierarchy("Internal QAing")
                        .putChildrenType("Alpha Test")
                        .putChildrenType("Functional Test")
                        .putChildrenType("Functional Review")
                        .eoH()
                    .atFeatureHierarchy("Developing")
                        .putChildrenType("Alpha Bug")
                        .putChildrenType("Subtask")
                        .putChildrenType("Backend Development")
                        .putChildrenType("Frontend Development")
                        .putChildrenType("UX")
                    .eoH()
                    .atFeatureHierarchy("Planning")
                        .putChildrenType("Feature Planning")
                        .putChildrenType("Tech Planning")
                    .eoH()
                    .atDemandHierarchy("UATing")
                        .putChildrenType("UAT")
                    .eoH()
                    .atDemandHierarchy("Doing")
                        .putChildrenStatus("Planning")
                        .putChildrenStatus("To Dev")
                        .putChildrenStatus("Developing")
                        .putChildrenStatus("To Internal QA")
                        .putChildrenStatus("Internal QAing")
                        .putChildrenStatus("QAing")
                    .eoH()
                .eoKpi()
                .statuses()
                    .withProgressingSatuses("Doing", "UATing", "Planning")
                    .withProgressingSatuses("Developing", "Internal QAing", "QAing")
                    .withProgressingSatuses("Reviewing", "Merging").withNotProgressingSatuses("Open", "To Do", "To UAT")
                    .withNotProgressingSatuses("Done", "Cancelled")
                    .withNotProgressingSatuses("To Plan", "To Dev", "To Internal QA", "To Deploy")
                    .withNotProgressingSatuses("To QA", "To Review", "To Merge")
                .eoS();
        return dsl;
    }
