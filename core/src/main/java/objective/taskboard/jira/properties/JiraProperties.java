...
@Validated
public class JiraProperties implements JiraClientProperties {
    @NotNull
    @NotEmpty
    private String url;
    @NotNull
    ...
    @NotNull
    @Valid
    private FinalStatuses finalStatuses;
    ...
    public FinalStatuses getFinalStatuses() {
    ...
    public void setFinalStatuses(final FinalStatuses finalStatuses) {
