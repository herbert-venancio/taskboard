...
import objective.taskboard.enumeration.CustomFields;
...
public class IssueController {
    ...
    public Issue createIssue(@RequestBody Issue issue) throws JSONException {
        ...
        issueBuilder.setFieldValue("timetracking", ComplexIssueInputFieldValue.with("originalEstimate", issue.getEstimativa()));
        issueBuilder.setFieldValue(CustomFields.TAMANHO, ComplexIssueInputFieldValue.with("id", issue.getCustomFields().get(CustomFields.TAMANHO).toString()));
        issueBuilder.setFieldValue(CustomFields.CLASSE_DE_SERVICO, ComplexIssueInputFieldValue.with("id", issue.getCustomFields().get(CustomFields.CLASSE_DE_SERVICO).toString()));
